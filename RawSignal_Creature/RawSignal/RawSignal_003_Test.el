{
//***** RawSignal_003_Test
// Testfil til RawSignal-Creature-automationen. Dækker typen: TO PARAMETRE
// (N1 og N2) + indbygget seriefunktion i en løkke.
//
...
//
// "003" er ikke et rigtigt filter_case_id. Filen er bygget uden adgang til
// TradingDB, ud fra formlen i RawSignalTest_1.el. Når databasen er
// tilgængelig, skal nummeret erstattes med det rigtige filter_case_id,
// og formlen bekræftes mod filter_case.filtere.
//
//
...
//----- Engangsopsætning: nulstil filen og skriv overskriftsrække -----//
	...
	Once
		Begin
		FileDelete( "C:\TradingDB_Folder\FilterFolder\RawSignal.CSV\RawSignal_003_Test.csv" );
		Print( File("C:\TradingDB_Folder\FilterFolder\RawSignal.CSV\RawSignal_003_Test.csv"), "RunID,N1,N2,Starttid,AntalBars" );
		End;
	...
	While N1 <= N1_Til
		...
		While N2 <= N2_Til
			...
			If Filter1[N1,N2] = 0 and Filter1_Forrige[N1,N2] = 1 Then
				Begin
				Print( File("C:\TradingDB_Folder\FilterFolder\RawSignal.CSV\RawSignal_003_Test.csv"),
				       "RawSignal_003_Test" + ","
				     + NumToStr( N1, 0 ) + ","
				     + NumToStr( N2, 0 ) + ","
				     + StartTekst[N1,N2] + ","
